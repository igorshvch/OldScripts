...
class MainPage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        entry_str1 = ttk.Entry(textvariable=string_1)
        entry_str1.grid(row=1, column=0, sticky='w')

        button1_process = ttk.Button(text='Process', command=LCS_main)
        button1_process.grid(row=1, column=1, sticky='e')

        entry_str2 = ttk.Entry(textvariable=string_2)
        entry_str2.grid(row=2, column=0, sticky='w')
        
        button2_clean = ttk.Button(text='Clean', command=clean)
        button2_clean.grid(row=2, column=1, sticky='e')

        label_mid_inform_1 = ttk.Label(textvariable=lists_similarity)
        label_mid_inform_1.grid(row=3, column=0, columnspan=2, sticky='w')
        label_mid_inform_2 = ttk.Label(textvariable=lenlist1)
        label_mid_inform_2.grid(row=4, column=0, columnspan=2, sticky='w')
        label_mid_inform_3 = ttk.Label(textvariable=lenlist2)
        label_mid_inform_3.grid(row=5, column=0, columnspan=2, sticky='w')
        label_mid_inform_4 = ttk.Label(textvariable=lenLCS)
        ...
        text_str1.insert('1.0', string_1_p)
        ...
        text_str2.insert('1.0', string_2_p)
