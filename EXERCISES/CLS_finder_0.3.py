...
class MainPage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        entry_str1 = ttk.Entry(textvariable=controller.string_1, width=90)
        ...
        entry_str2 = ttk.Entry(textvariable=controller.string_2, width=90)
        ...
        label_mid_inform_1 = ttk.Label(textvariable=controller.lists_similarity, font=INFOFONT)
        ...
        self.text_str1.tag_configure("green", background="#00ff00")
